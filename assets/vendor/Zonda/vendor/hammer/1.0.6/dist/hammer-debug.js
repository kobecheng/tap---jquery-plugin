define("/assets/vendor/Zonda/vendor/hammer/1.0.6/hammer-debug", [ "jquery-debug" ], function(require, exports, module) {
 ...
 */
        ...
        // DEBUG:Degas
        // Maybe return boolean, but return a string
        // So, use "test" replace "match"
        //Hammer.NO_MOUSEEVENTS = Hammer.HAS_TOUCHEVENTS && Hammer.MOBILE_REGEX.test(navigator.userAgent);
